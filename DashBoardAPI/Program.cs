...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowReactApp", policy =>
        policy.WithOrigins("http://localhost:3000", "http://CFTManagement.somee.com", "https://CFTManagement.somee.com", "https://cftmanagementr.vercel.app", "http://www.cftmanagement.somee.com")  // React default port
              .AllowAnyHeader()
              .AllowAnyMethod());
});
//builder.Services.AddCors(options =>
